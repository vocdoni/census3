...
var (
	...
	ErrNoTokens               = apirest.APIerror{Code: 4007, HTTPstatus: apirest.HTTPstatusNoContent, Err: fmt.Errorf("no tokens found")}
	ErrNoStrategies           = apirest.APIerror{Code: 4008, HTTPstatus: apirest.HTTPstatusNoContent, Err: fmt.Errorf("no strategy found")}
	...
	ErrCantCreateCensus       = apirest.APIerror{Code: 5001, HTTPstatus: apirest.HTTPstatusInternalErr, Err: fmt.Errorf("error creating the census tree on the census database")}
	...
	ErrCantGetCensus          = apirest.APIerror{Code: 5009, HTTPstatus: apirest.HTTPstatusInternalErr, Err: fmt.Errorf("error getting census information")}
	ErrEncodeToken            = apirest.APIerror{Code: 5010, HTTPstatus: apirest.HTTPstatusInternalErr, Err: fmt.Errorf("error encoding token")}
	ErrEncodeTokens           = apirest.APIerror{Code: 5011, HTTPstatus: apirest.HTTPstatusInternalErr, Err: fmt.Errorf("error encoding tokens")}
	ErrEncodeTokenTypes       = apirest.APIerror{Code: 5012, HTTPstatus: apirest.HTTPstatusInternalErr, Err: fmt.Errorf("error encoding supported tokens types")}
	ErrEncodeTokenHolders     = apirest.APIerror{Code: 5013, HTTPstatus: apirest.HTTPstatusInternalErr, Err: fmt.Errorf("error encoding token holders")}
	ErrEncodeStrategyHolders  = apirest.APIerror{Code: 5014, HTTPstatus: apirest.HTTPstatusInternalErr, Err: fmt.Errorf("error encoding strategy holders")}
	ErrEncodeStrategy         = apirest.APIerror{Code: 5015, HTTPstatus: apirest.HTTPstatusInternalErr, Err: fmt.Errorf("error encoding strategy")}
