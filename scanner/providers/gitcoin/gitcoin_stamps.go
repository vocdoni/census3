...
var stamps = map[string]*regexp.Regexp{
	...
	"GTC Staking":                regexp.MustCompile(`^[Beginner|Experienced]+CommunityStaker|^TrustedCitizen|^CommunityStaking[Bronze|Gold|Silver]+`),
	...
	"Gnosis Safe":                regexp.MustCompile(`^GnosisSafe`),
	"Google":                     regexp.MustCompile(`^Google`),
	"Guild Membership and Roles": regexp.MustCompile(`^Guild[Admin|Member|PassportMember]`),
	...
	"NFT Holder":                 regexp.MustCompile(`^NFT`),
	"PHI":                        regexp.MustCompile(`^PHIActivity[Gold|Silver]`),
	"Proof of Humanity":          regexp.MustCompile(`^Poh`),
	"Snapshot":                   regexp.MustCompile(`^Snapshot[Proposals|Votes]+Provider`),
	"Trusta Labs":                regexp.MustCompile(`^TrustaLabs`),
