...
const (
	...
	CONTRACT_TYPE_FARCASTER_KEY_REGISTRY
	CONTRACT_TYPE_FARCASTER_ID_REGISTRY
	// CONTRACT NAMES
	...
	CONTRACT_NAME_FARCASTER_KEY_REGISTRY = "farcasterkeyregistry"
	CONTRACT_NAME_FARCASTER_ID_REGISTRY  = "farcasteridregistry"
)
...
var tokenTypeStringMap = map[uint64]string{
	...
	CONTRACT_TYPE_FARCASTER_KEY_REGISTRY: CONTRACT_NAME_FARCASTER_KEY_REGISTRY,
	CONTRACT_TYPE_FARCASTER_ID_REGISTRY:  CONTRACT_NAME_FARCASTER_ID_REGISTRY,
}
...
var tokenTypeIntMap = map[string]uint64{
	...
	CONTRACT_NAME_FARCASTER_KEY_REGISTRY: CONTRACT_TYPE_FARCASTER_KEY_REGISTRY,
	CONTRACT_NAME_FARCASTER_ID_REGISTRY:  CONTRACT_TYPE_FARCASTER_ID_REGISTRY,
}
