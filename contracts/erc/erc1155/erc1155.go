...
func (_ERC1155Contract *ERC1155ContractCaller) Name(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _ERC1155Contract.contract.Call(opts, &out, "name")
...
//
// Solidity: function name() view returns(string)
func (_ERC1155Contract *ERC1155ContractSession) Name() (string, error) {
	return _ERC1155Contract.Contract.Name(&_ERC1155Contract.CallOpts)
}

// Name is a free data retrieval call binding the contract method 0x06fdde03.
//
// Solidity: function name() view returns(string)
func (_ERC1155Contract *ERC1155ContractCallerSession) Name() (string, error) {
	return _ERC1155Contract.Contract.Name(&_ERC1155Contract.CallOpts)
}
...
func (_ERC1155Contract *ERC1155ContractCaller) Symbol(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _ERC1155Contract.contract.Call(opts, &out, "symbol")
...
//
// Solidity: function symbol() view returns(string)
func (_ERC1155Contract *ERC1155ContractSession) Symbol() (string, error) {
	return _ERC1155Contract.Contract.Symbol(&_ERC1155Contract.CallOpts)
}

// Symbol is a free data retrieval call binding the contract method 0x95d89b41.
//
// Solidity: function symbol() view returns(string)
func (_ERC1155Contract *ERC1155ContractCallerSession) Symbol() (string, error) {
	return _ERC1155Contract.Contract.Symbol(&_ERC1155Contract.CallOpts)
}
...
func (_ERC1155Contract *ERC1155ContractCaller) Uri(opts *bind.CallOpts, id *big.Int) (string, error) {
	var out []interface{}
	err := _ERC1155Contract.contract.Call(opts, &out, "uri", id)
...
//
// Solidity: function uri(uint256 id) view returns(string)
func (_ERC1155Contract *ERC1155ContractSession) Uri(id *big.Int) (string, error) {
	return _ERC1155Contract.Contract.Uri(&_ERC1155Contract.CallOpts, id)
}

// Uri is a free data retrieval call binding the contract method 0x0e89341c.
//
// Solidity: function uri(uint256 id) view returns(string)
func (_ERC1155Contract *ERC1155ContractCallerSession) Uri(id *big.Int) (string, error) {
	return _ERC1155Contract.Contract.Uri(&_ERC1155Contract.CallOpts, id)
}
