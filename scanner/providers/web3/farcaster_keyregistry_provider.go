...
type FarcasterKeyRegistryProvider struct {
...
func (p *FarcasterKeyRegistryProvider) Init(iconf any) error {
...
func (p *FarcasterKeyRegistryProvider) SetRef(iref any) error {
	if p.endpoints == nil {
	...
	if err != nil {
		return errors.Join(ErrConnectingToWeb3Client, fmt.Errorf("[FARCASTER KEY REGISTRY] %s: %w", ref.HexAddress, err))
	}
	// set the client, parse the address and initialize the contract
	p.client = client
	address := common.HexToAddress(ref.HexAddress)
	if p.contract, err = fckr.NewFarcasterKeyRegistry(address, client); err != nil {
		return errors.Join(ErrInitializingContract, fmt.Errorf("[FARCASTER KEY REGISTRY] %s: %w", p.address, err))
	}
...
// balances.
func (p *FarcasterKeyRegistryProvider) SetLastBalances(_ context.Context, _ []byte,
...
func (p *FarcasterKeyRegistryProvider) SetLastBlockNumber(blockNumber uint64) {
...
func (p *FarcasterKeyRegistryProvider) HoldersBalances(ctx context.Context, _ []byte, fromBlock uint64) (
...
func (p *FarcasterKeyRegistryProvider) Close() error {
	return nil
}

// IsExternal returns false because the provider is not an external API.
func (p *FarcasterKeyRegistryProvider) IsExternal() bool {
	return false
}
...
func (p *FarcasterKeyRegistryProvider) IsSynced(_ []byte) bool {
	return p.synced.Load()
}

// Address returns the address of the current token set in the provider.
func (p *FarcasterKeyRegistryProvider) Address() common.Address {
	return p.address
}

// Type returns the type of the current token set in the provider.
func (p *FarcasterKeyRegistryProvider) Type() uint64 {
	return providers.CONTRACT_TYPE_FARCASTER_KEY_REGISTRY
}

// TypeName returns the type name of the current token set in the provider.
func (p *FarcasterKeyRegistryProvider) TypeName() string {
	return providers.TokenTypeName(providers.CONTRACT_TYPE_FARCASTER_KEY_REGISTRY)
}

// ChainID returns the chain ID of the current token set in the provider.
func (p *FarcasterKeyRegistryProvider) ChainID() uint64 {
	return p.chainID
}
...
// the provider.
func (p *FarcasterKeyRegistryProvider) Name(_ []byte) (string, error) {
...
func (p *FarcasterKeyRegistryProvider) Symbol(_ []byte) (string, error) {
	return "", nil
}
...
func (p *FarcasterKeyRegistryProvider) Decimals(_ []byte) (uint64, error) {
	return 0, nil
}
...
func (p *FarcasterKeyRegistryProvider) TotalSupply(_ []byte) (*big.Int, error) {
...
func (p *FarcasterKeyRegistryProvider) BalanceOf(addr common.Address, _ []byte) (*big.Int, error) {
	return big.NewInt(0), nil
}
...
// used by the provider.
func (p *FarcasterKeyRegistryProvider) BalanceAt(ctx context.Context, addr common.Address,
...
func (p *FarcasterKeyRegistryProvider) BlockTimestamp(ctx context.Context, blockNumber uint64) (string, error) {
...
func (p *FarcasterKeyRegistryProvider) BlockRootHash(ctx context.Context, blockNumber uint64) ([]byte, error) {
...
// receives an external ID but it is not used by the provider.
func (p *FarcasterKeyRegistryProvider) LatestBlockNumber(ctx context.Context, _ []byte) (uint64, error) {
...
// of blocks.
func (p *FarcasterKeyRegistryProvider) CreationBlock(ctx context.Context, _ []byte) (uint64, error) {
	var err error
...
func (p *FarcasterKeyRegistryProvider) IconURI(_ []byte) (string, error) {
	return "", nil
}

// Return an array of all active keys for a given fid
func (p *FarcasterKeyRegistryProvider) KeysOf(fid *big.Int) ([][]byte, error) {
	return p.contract.KeysOf(nil, fid, 1) // 1 is the default key state
}
